...
import LandingCategoryPageDesktop from '@modules/layout/desktop/landingCategory';
const LandingCategoryPageContainer = () => {
    ...
    const homeData = useSelector(selectGetHomePage);
    ...
    return (
        <RenderContext
            components={{
                desktop: {
                    defaultTheme: LandingCategoryPageDesktop,
                },
                mobile: {
...
export default LandingCategoryPageContainer;
